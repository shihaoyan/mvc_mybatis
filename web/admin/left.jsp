...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('010101','0101','展示所有','${pageContext.request.contextPath}/admin/user/list','','mainFrame');
		d.add('0102','01','分类管理','','','mainFrame');
		d.add('010201','0102','展开所有','${pageContext.request.contextPath}/admin/category/list','','mainFrame');
