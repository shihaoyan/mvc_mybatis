...
<body>
<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/user/admin/update"
      method="post">
    ...
    <table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee"
        ...
        <tr>
            ...
            <td class="ta_01" bgColor="#ffffff">
                <input type="text" name="account" value="${user.account}" class="bg"/>
            </td>
            <td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
                密码：
            </td>
        ...
        <tr>
            ...
            <td class="ta_01" bgColor="#ffffff">
                <input type="text" name="username" value="${user.username}" id="userAction_save_do_logonName"
                       class="bg"/>
            </td>
        </tr>
        <tr>
